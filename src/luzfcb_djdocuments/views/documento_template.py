...
#             quantidade_meus_documentos = models.DocumentoTemplate.objects.all().filter(criado_por=self.request.user).count()
#             quantidade_documentos_cadastrados = models.DocumentoTemplate.objects.all().count()
...
#     model = models.DocumentoTemplate
#
