    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo_dono', models.ForeignKey(related_name='djdocuments_documento_donos', to='auth.Group', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo_dono', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, blank=True, to='auth.Group', null=True)),
