    ...
    <script type="text/javascript">
        ...
        function ODFViewerPlugin() {
            function b(b) {
                ...
                a.async = !1;
                a.src = "{% static 'luzfcb_djdocuments/js/viewerjs/webodf.js' %}";
        ...
        function PDFViewerPlugin() {
            ...
            function r(d) {
                var a;
                b("{%  static 'luzfcb_djdocuments/js/viewerjs/compatibility.js' %}", function () {
                    b("{%  static 'luzfcb_djdocuments/js/viewerjs/pdf.js' %}");
                    b("{%  static 'luzfcb_djdocuments/js/viewerjs/ui_utils.js' %}");
                    b("{%  static 'luzfcb_djdocuments/js/viewerjs/text_layer_builder.js' %}");
                    b("{%  static 'luzfcb_djdocuments/js/viewerjs/pdfjsversion.js' %}", d)
                });
                a = document.createElementNS(document.head.namespaceURI, "style");
                a.setAttribute("media", "screen, print, handheld, projection");
                a.setAttribute("type", "text/css");
            ...
            this.initialize = function (a, b) {
                var c;
                r(function () {
                    PDFJS.workerSrc = "{%  static 'luzfcb_djdocuments/js/viewerjs/pdf.worker.js' %}";
        ...
        (function () {
            ...
            var k, q = [function () {
                ...
                return {
                    ...
                    }, path: "{%  static 'luzfcb_djdocuments/js/viewerjs/ODFViewerPlugin/' %}", getClass: function () {
                ...
                supportsMimetype: function (a) {
                    ...
                    return "pdf" === a
                }, path: "{%  static 'luzfcb_djdocuments/js/viewerjs/PDFViewerPlugin/' %}", getClass: function () {
