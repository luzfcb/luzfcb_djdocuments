...
var pdfworkerjssrc = null;
var pdfcMapUrl = null;

if(window.pdfworkerjssrc !== undefined && window.pdfworkerjssrc !== null) {
    pdfworkerjssrc = window.pdfworkerjssrc;
}else{
    pdfworkerjssrc = '../build/pdf.worker.js';
}
if(window.pdfcMapUrl !== undefined && window.pdfcMapUrl !== null) {
    pdfcMapUrl = window.pdfcMapUrl;
}else{
    pdfcMapUrl = '../web/cmaps/';
}


function configure(PDFJS) {
 PDFJS.imageResourcesPath = './images/';
 PDFJS.workerSrc = pdfworkerjssrc;
 PDFJS.cMapUrl = pdfcMapUrl;
