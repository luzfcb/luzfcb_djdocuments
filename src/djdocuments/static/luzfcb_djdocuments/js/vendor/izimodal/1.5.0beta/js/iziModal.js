...
(function(window) {
    ...
    (function(fnRegister) {
        if (typeof define === "function" && define.amd) { // With AMD support
            define(["jquery"], fnRegister);
        } else { // No AMD support
            fnRegister(window.jQuery);
        }
		...
		iziModal.prototype = {
				...
				function bindEvents(){
		            ...
		            that.$element.off('click', '[data-'+PLUGIN_NAME+'-fullscreen]').on('click', '[data-'+PLUGIN_NAME+'-fullscreen]', function (e) {
		                ...
		                if(that.isFullscreen === true){
			                ...
			                that.$element.removeClass('isAttachedBottom');
			                that.$element.removeClass('isAttachedTop');
		                } else {
			...
			recalcLayout: function(){
	            ...
	            if(this.state == STATES.OPENED || this.state == STATES.OPENING){
	                ...
	                if (windowHeight > (contentHeight + this.headerHeight) && this.isFullscreen === false) {
	        		...
	        		if(this.isFullscreen === false && this.$element.hasClass('isAttached') && this.$element.width() >= $window.width() ){
	            	...
	            	if (outerHeight > windowHeight && this.isFullscreen === false) {

						if(this.options.top > 0){
					    	this.$element.addClass('isAttachedBottom');
						} else if(this.options.bottom > 0){
					    	this.$element.addClass('isAttachedTop');
						}
				    	...
				    	if( (this.options.top > 0 || this.options.bottom > 0) && (this.options.attached !== 'top' || this.options.attached !== 'bottom') && this.isFullscreen === false){

			    		 	if(this.$element.hasClass('isAttachedBottom'))
					    		this.$element.removeClass('isAttachedBottom');
					    	if(this.$element.hasClass('isAttachedTop'))
		            ...
		            (function internalScroll(){
		                ...
		                var scrollTop = that.$element.find('.'+PLUGIN_NAME+'-wrap').scrollTop(),
		                	internoHeight = that.$element.find('.'+PLUGIN_NAME+'-content').innerHeight(),
		                	externoHeight = that.$element.find('.'+PLUGIN_NAME+'-wrap').innerHeight();
